...
joblib.dump(
    word_vectorizer,
    os.path.join(MODEL_DIR, "word_vectorizer.joblib")
)

joblib.dump(
    char_vectorizer,
    os.path.join(MODEL_DIR, "char_vectorizer.joblib")
)
...
print("\n=== Saved Model Files ===")
print("models/word_vectorizer.joblib")
print("models/char_vectorizer.joblib")
print("models/phishing_model.joblib")